...
navigator.geolocation.getCurrentPosition(function (position) {
    ...
    dte.text(tmdate);
    $.ajax({
        url: `http://api.weatherapi.com/v1/history.json?q=${lat, long}&dt=${tmdate}&key=4aadb5ff6b43428cb37153814233005`,
        method: "GET",
...
function mainApiCall(loction, date) {
    ...
    $.ajax({
        url: `http://api.weatherapi.com/v1/history.json?q=${loction}&dt=${date}&key=4aadb5ff6b43428cb37153814233005`,
        method: "GET",
        success: function (resp) {
            maniDeatils(resp);
...
function maniDeatils(resp) {
    ...
    precipitation.text("precipitation  : " + resp.forecast.forecastday[0].day.totalprecip_mm + " mm");
    ...
    vision.text("Vision : " + resp.forecast.forecastday[0].day.avgvis_km + " (km)");
